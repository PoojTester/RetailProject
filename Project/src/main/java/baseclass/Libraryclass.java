...
import io.github.bonigarcia.wdm.WebDriverManager;
	...
	public class Libraryclass {
		...
		try {
		FileInputStream inputStream = new FileInputStream("C:\\Project\\src\\test\\resources\\Configuration.property\\config.property");
		try {
		...
		PropertyConfigurator.configure("C:\\Project\\src\\test\\resources\\Log4J.property\\log4J.property");
